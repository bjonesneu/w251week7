...
docker run --rm -v /usr/src/w251week3:/src --env CLOUD_MQTT_HOST --env CLOUD_MQTT_PORT --name imagefwdclient --network hw03 -d mqttclient python3 /src/imagefwdapp.py
